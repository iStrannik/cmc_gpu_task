...
int main(int argc, char **argv) {
    ...
    double tau = 0.0;
    double result = 0;
    #pragma acc data copy(result, w[0:global_step_x * global_step_y], r[0:global_step_x * global_step_y], Ar[0:global_step_x * global_step_y], operatorA_a[0:global_step_x * global_step_y], operatorA_b[0:global_step_x * global_step_y], operatorA_f[0:global_step_x * global_step_y], extended_A[0:2 * (global_step_x + global_step_y)], extended_B[0:2 * (global_step_x + global_step_y)], extended_w[0:2 * (global_step_x + global_step_y)], recieve_buffer_r[0:2 * (global_step_x + global_step_y)], send_buffer_r[0:2 * (global_step_x + global_step_y)])
    do {
